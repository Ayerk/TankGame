...
public class FailGame extends ElementObj{
	...
	public void showElement(Graphics g) {
	    ...
	    String failStr = "原因："+cause;
	    Rectangle2D textBounds2 = fm.getStringBounds(failStr, g2d);
	    int textX2 = (getW() - (int) textBounds2.getWidth()) / 2;
	    g2d.drawString(failStr, textX2, textY);
	}
